...
import calibrateB
rvecs = calibrateB.rvecs
tvecs = calibrateB.tvecs
...
intrinsic_matx = np.append( np.append(calibrateB.mtx, [[0],[0],[1]], axis=1), [np.array([0,0,0,1])], axis=0)

print(calibrateB.mtx)
...
projection_points = np.array([[7],[21],[34],[1]])
